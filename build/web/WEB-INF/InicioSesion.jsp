...
<html>
    ...
    <body id="bdy">
        ...
        <div id="isss">
            ...
            <br>
            <center>
                <h1 id="tle">Inicio de Sesion A.</h1>
            </center>

            <c:forEach items="${unAdministrador.Listar(0)}" var="elAdministrador">
                <Center>   <p id="di" class="shining-text" ></p> </Center>
                <form action="ControladorLogin" method="post" id="fm" class="row g-3 needs-validation" novalidate>

                    <div class="col-md-9">
                        <br><label id="lbl" for="validationCustom01" class="form-label">Ingrese Su Correo</label><br>
                        <input name="fCorreoAdm" type="email" class="form-control" value="${elAdministrador.CorreoAdm}" id="validationCustom01" required>
                        ...
                        <div class="col-md-12">
                            <br><br>
                            <label id="lbl" for="validationCustom03" class="form-label">Ingrese su Contraseña</label>
                            <br><input name="CAdm" type="password" class="form-control" value="${elAdministrador.ContraseñaAdm}" id="validationCustom03" required>
                            <div class="valid-feedback">
                                Ok
                            </div>
                            <div class="invalid-feedback">
